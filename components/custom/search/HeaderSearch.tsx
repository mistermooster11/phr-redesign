    ...
    return (
        ...
        <div className="relative z-[100] h-full flex items-center pr-[1.5rem] ">
            <button
                ...
                className="bg-transparent border-0 cursor-pointer text-black block p-0 leading-none"
                aria-label="Search"
                >
            ...
            {searchOpen && (
                <div className="fixed top-[8rem]  right-20 z-[9999] bg-[#000000] px-[5%] box-border">
